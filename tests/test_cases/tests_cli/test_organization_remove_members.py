...
class TestCLIOrganizationRemoveMembers(BaseCLITest):
    ...
    async def test_admin_remove_user_from_org_cli(self) -> None:
        ...
        await self._cli_steps.cli_remove_user_from_org(
            org_name=org.org_name, username=second_user.username
        )
        await self._cli_steps.cli_get_org_users(org_name=org.org_name)
        await self._cli_steps.verify_cli_user_not_in_orgs_users_output(
            username=second_user.username,
            role="User",
            email=second_user.email,
            credits="unlimited",
        ...
        await self._cli_steps.cli_verify_login_output(second_user.username)
    ...
    async def test_manager_remove_user_from_org_cli(self) -> None:
        ...
        await self._cli_steps.cli_login_with_token(token=third_user.token)
        await self._cli_steps.cli_verify_login_output(third_user.username)
